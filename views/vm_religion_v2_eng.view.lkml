view: vm_religion_v2_eng {
  sql_table_name: `jutomate-lamas-english.MODELLING.vm_religion_v2_eng` ;;
...
#
  ...
  # html: <div style=line-height:1.2;font-size:16px;>Main religion<br><span style="color:#2D4A99;font-size:44px;">{{ religion_heb }}</span><br><span style="color:#2D4A99;font-size:44px;">{{ value_m_2 }}%</span> ;;
